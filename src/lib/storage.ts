...
const tutorialItems: Array<{ body: string; annotation: string }> = [
  { body: '↑この白いところに文字を記入', annotation: '' },
  { body: '記入してEnterすればメモ入力完了', annotation: '' },
  { body: 'メモをダブルタップすると修正', annotation: '' },
  {
    body: '右側の三角形を押すと詳細を追記',
    annotation:
      'ここが追記欄です。たくさんの文字を書けます。三角形を押せば閉じられます。',
  },
  {
    body: '書いたメモは7日後に消えます',
